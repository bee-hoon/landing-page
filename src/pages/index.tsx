  ...
  return (
    ...
    >
      ...
      <section className='call-to-action mt-10'>
        <a href="mailto:syauqeesy@gmail.com" className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mr-2 rounded'>Hire me!</a>
        <a href="https://github.com/bee-hoon" className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded'>Projects</a>
      </section>
